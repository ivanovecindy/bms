...
GridTree.prototype.loadData = function(obj) {
	...
	tc = $.extend({
			...
			closeImg : basepath+'/js/gridTree/images/minus.gif',//父级节点的关闭图标
			openImg :  basepath+'/js/gridTree/images/plus.gif',//父级节点的打开图标
			lazyLoadImg :  basepath+'/js/gridTree/images/plus2.gif',//懒加载时显示的图标
			blankImg :  basepath+'/js/gridTree/images/blank.gif',//空白节点
			noparentImg :  basepath+'/js/gridTree/images/leaf.gif',//树叶节点的图标
	...
	if (tc.styleOption == null||(tc.styleOption+'')!='2') {
		_style = 2;
		 importcss(basepath+"/js/gridTree/GridTree2.css");
	}else{
		_style = tc.styleOption;
		 importcss(basepath+"/js/gridTree/GridTree.css");
	}	
